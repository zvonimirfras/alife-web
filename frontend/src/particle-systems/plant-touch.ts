...
export const getPlantTouchParticleSystem = (position: Vector3, scene: Scene) => {
...
export const runPlantTouchParticleSystem = (position: Vector3, scene: Scene) => {
	const particleSystem = getPlantTouchParticleSystem(position, scene);
