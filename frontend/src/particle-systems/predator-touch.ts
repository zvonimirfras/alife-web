...
export const getPredatorTouchParticleSystem = (position: Vector3, scene: Scene) => {
...
export const runPredatorTouchParticleSystem = (position: Vector3, scene: Scene) => {
	const particleSystem = getPredatorTouchParticleSystem(position, scene);
